...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_QCS is
  ...
  signal rpmlut_addr1 : STD_LOGIC_VECTOR ( 13 downto 1 );
  signal rpmlut_addr2 : STD_LOGIC;
  ...
  signal \rpmlut_addr_reg[13]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \NLW_rpmlut_addr_reg[13]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_rpmlut_addr_reg[13]_i_3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute SOFT_HLUTNM of \rpmlut_addr_reg[0]_i_1\ : label is "soft_lutpair7";
  ...
  attribute ADDER_THRESHOLD of \rpmlut_addr_reg[13]_i_3\ : label is 35;
...
\rpm_reg[15]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => clk_counter(15),
      I3 => \rpm_reg[15]_i_4_n_0\,
      I4 => \rpm_reg[15]_i_5_n_0\,
      I5 => clk_counter(14),
      O => \rpm_reg[15]_i_1_n_0\
    );
\rpm_reg[15]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\rpm_reg[15]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\rpmlut_addr2_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
        ...
        port map (
      I0 => \rpm_reg[15]_i_1_n_0\,
      I1 => \rpmlut_addr2_carry__0_i_3_n_4\,
      O => \rpmlut_addr2_carry__0_i_1_n_0\
    );
\rpmlut_addr2_carry__0_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0033003300009009"
    )
        port map (
      I0 => \rpmlut_addr2_carry__0_i_3_n_6\,
      I1 => rpmlut_addr(13),
      I2 => \rpmlut_addr2_carry__0_i_3_n_7\,
      I3 => rpmlut_addr(12),
      I4 => \rpmlut_addr2_carry__0_i_3_n_5\,
      I5 => \rpm_reg[15]_i_1_n_0\,
...
\rpmlut_addr2_carry__0_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 2) => ch_counter(15 downto 14),
      S(1) => \rpmlut_addr2_carry__0_i_6_n_0\,
      S(0) => \rpmlut_addr2_carry__0_i_7_n_0\
    );
\rpmlut_addr2_carry__0_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\rpmlut_addr_reg[13]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \rpm_reg[15]_i_1_n_0\,
      I1 => rst,
      O => \rpmlut_addr_reg[13]_i_2_n_0\
    );
\rpmlut_addr_reg[13]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => \rpmlut_addr_reg[12]_i_2_n_0\,
      CO(3 downto 0) => \NLW_rpmlut_addr_reg[13]_i_3_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 1) => \NLW_rpmlut_addr_reg[13]_i_3_O_UNCONNECTED\(3 downto 1),
      O(0) => rpmlut_addr1(13),
      S(3 downto 1) => B"000",
      S(0) => ch_counter(13)
    );
\rpmlut_addr_reg[13]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
