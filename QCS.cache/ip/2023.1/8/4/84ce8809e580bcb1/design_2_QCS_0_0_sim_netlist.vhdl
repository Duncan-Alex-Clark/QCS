...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_QCS is
  ...
  signal \rpmlut_addr_rep[13]_i_2_n_0\ : STD_LOGIC;
  signal \rpmlut_addr_rep[13]_i_3_n_0\ : STD_LOGIC;
  signal \rpmlut_addr_rep[13]_i_4_n_0\ : STD_LOGIC;
  signal \rpmlut_addr_rep[13]_i_5_n_0\ : STD_LOGIC;
...
\ch_counter[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => ch_a_prev,
      I3 => ch_a_reg,
      I4 => \rpmlut_addr_rep[13]_i_2_n_0\,
...
\ch_counter[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => \rpmlut_addr_rep[13]_i_2_n_0\,
      I1 => ch_counter_reg(0),
...
\ch_counter[0]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"4"
        ...
        port map (
      I0 => ch_counter_reg(0),
      I1 => \rpmlut_addr_rep[13]_i_2_n_0\,
...
\rpmlut_addr_rep[13]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"1055FFFF"
    )
        port map (
      I0 => clk_counter(15),
      I1 => \rpmlut_addr_rep[13]_i_3_n_0\,
      I2 => \rpmlut_addr_rep[13]_i_4_n_0\,
      I3 => clk_counter(14),
      I4 => \rpmlut_addr_rep[13]_i_5_n_0\,
      O => \rpmlut_addr_rep[13]_i_2_n_0\
    );
\rpmlut_addr_rep[13]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => clk_counter(13),
      I3 => clk_counter(12),
      O => \rpmlut_addr_rep[13]_i_3_n_0\
    );
\rpmlut_addr_rep[13]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"01FF"
    )
        port map (
      ...
      I2 => clk_counter(8),
      I3 => clk_counter(9),
      O => \rpmlut_addr_rep[13]_i_4_n_0\
    );
\rpmlut_addr_rep[13]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
begin
  CH_COUNTER(15) <= \<const0>\;
  CH_COUNTER(14) <= \<const0>\;
  CH_COUNTER(13) <= \<const0>\;
  CH_COUNTER(12) <= \<const0>\;
  CH_COUNTER(11) <= \<const0>\;
  CH_COUNTER(10) <= \<const0>\;
  CH_COUNTER(9) <= \<const0>\;
  CH_COUNTER(8) <= \<const0>\;
  CH_COUNTER(7) <= \<const0>\;
  CH_COUNTER(6) <= \<const0>\;
