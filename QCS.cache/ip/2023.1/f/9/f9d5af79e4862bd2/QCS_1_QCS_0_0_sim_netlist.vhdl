...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_QCS is
  port (
    ...
    RPM : out STD_LOGIC_VECTOR ( 0 to 0 );
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
    ch_a : in STD_LOGIC;
    ch_b : in STD_LOGIC
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_QCS is
  ...
  signal \^rpm\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal STAGE_5 : STD_LOGIC_VECTOR ( 12 to 12 );
  ...
  signal \rpm_reg[12]_i_1_n_0\ : STD_LOGIC;
...
begin
  ...
  RPM(0) <= \^rpm\(0);
\STAGE_5[12]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\rpm_reg[12]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      I0 => STAGE_5(12),
      I1 => \rpm_reg[12]_i_2_n_0\,
      I2 => \^rpm\(0),
      O => \rpm_reg[12]_i_1_n_0\
    );
\rpm_reg[12]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAFA6FF6"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^rpm\ : STD_LOGIC_VECTOR ( 11 to 11 );
