...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_QCS is
  ...
  signal STAGE_5 : STD_LOGIC_VECTOR ( 13 to 13 );
...
begin
  ...
  RPM(0) <= \^rpm\(0);
\STAGE_5[13]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\rpm_reg[13]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\rpm_reg[13]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAFA6FF6"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^rpm\ : STD_LOGIC_VECTOR ( 12 to 12 );
