...
HD_PWD='/home/duncan/QCS/QCS.runs/seq_probe_divider_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_probe_divider_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_probe_divider_0_0.tcl
