...
HD_PWD='/home/duncan/QCS/QCS.runs/QCS_1_QCS_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QCS_1_QCS_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QCS_1_QCS_0_0.tcl
