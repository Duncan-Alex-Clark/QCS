...
HD_PWD='/home/duncan/QCS/QCS.runs/QCS_1_dlmb_bram_if_cntlr_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QCS_1_dlmb_bram_if_cntlr_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QCS_1_dlmb_bram_if_cntlr_1.tcl
