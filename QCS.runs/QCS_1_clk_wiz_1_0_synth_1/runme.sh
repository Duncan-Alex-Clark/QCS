...
HD_PWD='/home/duncan/QCS/QCS.runs/QCS_1_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QCS_1_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QCS_1_clk_wiz_1_0.tcl
