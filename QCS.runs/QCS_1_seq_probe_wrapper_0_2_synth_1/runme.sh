...
HD_PWD='/home/duncan/QCS/QCS.runs/QCS_1_seq_probe_wrapper_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QCS_1_seq_probe_wrapper_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QCS_1_seq_probe_wrapper_0_2.tcl
